        ...
        <div className="px-5 py-4">
          ...
          <div className="grid grid-cols-2 gap-3 pb-4">
            {uploadedImages.map((item, i) => (
              ...
              >
                <div className={`relative aspect-square w-full rounded-xl overflow-hidden border-2 transition-all shadow-sm ${tempSelectedImage?.url === item.url ? 'border-indigo-600 ring-2 ring-indigo-100' : 'border-transparent hover:border-gray-200'}`}>
