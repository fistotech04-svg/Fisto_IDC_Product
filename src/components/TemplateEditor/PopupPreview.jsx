...
const PopupPreview = ({ content, styles, elementType, elementSource, renderId, mode, onClose, onUpdateContent, onUpdateImage, onSelectElement, isWorkspaceModal = false }) => {
    ...
    return (
        ...
        >
            <div
                className={`${isHTML ? '' : 'border-gray-100 shadow-[0_20px_60px_rgba(0,0,0,0.15)]'} rounded-[16px] relative flex flex-col items-center pointer-events-auto scale-in-center transition-all duration-300`}
                onClick={(e) => {
                    e.stopPropagation();
                    if (onSelectElement) onSelectElement('background');
                }}
                style={{
                    ...
                    maxWidth: isHTML ? '95vw' : '900px',
                    height: '85%',
                    maxHeight: '95vh',
                    minWidth: isHTML ? 'auto' : '320px',
                    minHeight: isHTML ? 'auto' : '400px',
                    minHeight: isHTML ? 'auto' : '400px',
                    padding: isHTML ? '0' : '60px 40px',
                    overflow: 'hidden',
                    ...
                    {isHTML ? (
                        ...
                        <div className="w-full flex flex-col items-center gap-8">
                            {elementSource ? (
                                ...
                                <div className="text-gray-400 text-sm italic py-10 flex flex-col items-center gap-2">
                            ...
                            {content && (
                                <div
                                    ...
                                    className="break-words whitespace-pre-wrap w-full text-center px-4 outline-none border-b border-transparent hover:border-gray-200 focus:border-indigo-400 transition-all"
                                    style={{
